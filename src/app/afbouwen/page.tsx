  ...
  return (
    <>
      <div className="mt-32 flex w-full max-w-[800px] flex-col items-center gap-12 px-4">
        <h1 className="text-5xl font-extrabold tracking-tight text-red-950 text-opacity-80 sm:text-[5rem]">
          Afbouwen
        </h1>
        <Accordion type="single" collapsible className="w-full text-black">
          <AccordionItem
            value="item-1"
            className="border-red-950 border-opacity-40"
          >
            <AccordionTrigger className="rounded-md bg-red-900 bg-opacity-30 p-4">
              Lorem Ipsum
            </AccordionTrigger>
            <AccordionContent className="flex flex-col bg-red-900 bg-opacity-5 p-6">
              ...
              <Dialog>
                ...
                <DialogContent className="max-h-[80vh] w-11/12 max-w-none overflow-scroll rounded-md p-8 lg:w-2/3 lg:p-12">
                  <DialogHeader>
          ...
          >
            ...
            <AccordionContent className="bg-red-900 bg-opacity-5 p-6">
