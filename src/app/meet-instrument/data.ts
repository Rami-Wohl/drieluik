...
export const financesScoreLabels = [
  "1 - Ik heb geen inkomen en wel oplopende schulden.",
  "2 - Ik heb geen inkomen, maar mijn schulden zijn stabiel.",
  "3 - Ik heb geen inkomen en geen schulden.",
  "4 - Ik heb een inkomen, maar ook oplopende schulden.",
