...
const LachgasAlgemeen = () => {
  return (
    <>
      <StyledParagraph header="Wat is lachgas?">
        Lachgas (distikstofmonoxide of N₂O) is een kleurloos gas met een licht
        ...
        ballonnen, die gevuld worden met lachgas uit ampullen of cilinders.
      </StyledParagraph>
      <StyledParagraph header="Werkingsmechanisme:">
        Lachgas heeft een verdovende en dissociatieve werking. Het beïnvloedt
      ...
      <StyledParagraph header="Sociaal gedrag:">
        Lachgasgebruik is vaak verbonden aan feesten of informeel gebruik in
