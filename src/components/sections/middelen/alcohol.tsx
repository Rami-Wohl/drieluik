...
export function AlcoholSection() {
  return (
    <div>
      ...
      <Separator className="mt-12 border-b-2 border-black border-opacity-30" />
      <h3 className="mb-2 mt-12 w-full font-sans text-base font-semibold tracking-[1px] text-[#333333] lg:tracking-[0.1rem]">
      ...
      <h3 className="mb-6 mt-12 w-full font-sans text-base font-semibold tracking-[1px] text-[#333333] lg:tracking-[0.1rem]">
        Aanvullende begeleiding en ondersteuning
      </h3>
      <ol className="flex flex-col px-4">
        <ListItem ordered>
          <h3 className="mb-2 w-full font-sans text-base font-semibold tracking-[1px] text-[#333333] lg:tracking-[0.1rem]">
