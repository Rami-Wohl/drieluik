...
export default function TijdslijnIcon({ ...props }: SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
    ...
    >
      ...
      <path
        fill="#2B3B4E"
        d="M344.836,145.58l-29.449,29.449l-4.579,71.704l-93.968-93.915l-1.395,2.574l-21.583-22.725
	...
	c51.274-51.276,76.241-118.889,74.921-186.084L404.29,142.419L344.836,145.58z"
      ...
      <path
        fill="#FFD15D"
        d="M369.654,107.787l-8.533,8.532l19.542,19.542h-18.832c-28.598,0-51.862,23.266-51.862,51.864v155.82
	...
	c0-21.944,17.851-39.796,39.795-39.796h19.88l-20.589,20.589l8.533,8.532l34.632-34.632L369.654,107.787z"
      />
      <circle fill="#7DCC93" cx="315.578" cy="265.637" r="19.323" />
      <g>
        <circle fill="#90DFAA" cx="225.987" cy="265.637" r="19.323" />
        <circle fill="#90DFAA" cx="179.976" cy="146.101" r="19.323" />
        <circle fill="#90DFAA" cx="132.12" cy="265.637" r="19.323" />
        <circle fill="#90DFAA" cx="270.153" cy="385.345" r="19.323" />
      </g>
      <path
        fill="#7DCC93"
        d="M289.473,385.343c0-10.599-8.535-19.194-19.106-19.313v38.626
